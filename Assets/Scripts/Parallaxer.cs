...
public class Parallaxer : MonoBehaviour
{
    ...
    public bool spawnImmediately; // Particle Prewarm
    ...
    void Spawn()
    {
        ...
        if (t == null) // If true - poolSize is too small
        {
            return;
        }
    ...
    /* Method checks if the poolObject is off the screen,
     * If it is, we dispose the ibject from the screen
     */
